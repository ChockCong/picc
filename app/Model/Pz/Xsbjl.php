...
//            ->where('Pass1','=','1')
    ...
    public static function pass($order,$advice){
        $bool=DB::update('update main set Pass7 = ?,Pass3 = ?,Tag7 = ?,Advice7 = ?  where Order1 = ?',
            [0,1,1,$advice,$order]);
        return $bool;
    }
    ...
    public static function backreject($s,$advice,$order){
        ...
        $bool=DB::update('update main set Reject7 = ? , Advice7 = ? ,'.$s.'= ? where Order1 = ?',
            [null,$advice,1,$order]);
        return $bool;

    }
    public static function reject($order,$s,$i,$advice){
        $bool=DB::update('update main set Pass7 = ?, Tag7 = ? , '.$s.'  = ? ,Advice7 = ? where Order1 = ? ',
            [0,1,$i,$advice,$order]);
        return $bool;
    }
