...
use App\Model\Pz\Cxbjl;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;


class CxbjlController extends Controller{
    ...
    public function consearch(Request $request){
        ...
        if (!Empty($o) || (!Empty($d) && !Empty($e))){
            $row=Cxbjl::consearch($searchmessage);
            if (!Empty($row)){
    ...
    public function consearched(Request $request){
        ...
        if (!Empty($o) || (!Empty($d) && !Empty($e))){
            $row=Cxbjl::consearched($searchmessage);
            if (!Empty($row)){
    ...
    public function detailx($order,Request $request){
        ...
        $row=Cxbjl::detailx($order);
        $f=Jydw::getfiles($order);
        return view('Pz.cxbjl.detailx',compact('row','f'));
    }
    public function detaily($order,Request $request){
        ...
        $row=Cxbjl::detailx($order);
        $f=Jydw::getfiles($order);
        return view('Pz.cxbjl.detaily',compact('row','f'));
    }
    ...
    public function rejected(Request $request){
        ...
        $row=Cxbjl::rejected();
        return view('Pz.cxbjl.rejected',compact('row'));
    }
    ...
    public function rejectedtails($order,Request $request){
        ...
        $row=Cxbjl::detailx($order);
        $f=Jydw::getfiles($order);
        return view('Pz.cxbjl.rejecteddetail',compact('row','f'));
    }
