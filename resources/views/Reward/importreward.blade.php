...
<nav class="nav navbar-default navbar-mystyle navbar-fixed-top">
    <div class="navbar-header">
        ...
        <a href="{{url('jydwjlsmain')}}"><div class="navbar-brand mystyle-brand"><span class="glyphicon glyphicon-home"></span></div></a></div>
        ...
        {{--<div class="subNavBox">--}}
            {{--<div class="sBox">--}}
                ...
                {{--<ul class="navContent" style="display:block">--}}
                    {{--<li>--}}
                        {{--<div class="showtitle" style="width:100px;"><img src="img/leftimg.png" />奖励佣金导入</div>--}}
                        {{--<a href="{{url('jydwjlssearchx')}}" target="Center"><span class="sublist-icon glyphicon glyphicon-credit-card"></span><span class="sub-title">奖励佣金导入</span></a> </li>--}}
                    {{--<li>--}}
                        {{--<div class="showtitle" style="width:100px;"><img src="img/leftimg.png" />批增已审批</div>--}}
                        {{--<a href="{{url('jydwjlssearchy')}}" target="Center"><span class="sublist-icon glyphicon glyphicon-credit-card"></span><span class="sub-title">奖励佣金查询</span></a> </li>--}}
                {{--</ul>--}}
            {{--</div>--}}
            {{--<div class="sBox">--}}
            ...
            <div class="container-fluid">
                <div class="info-center">
                    ...
                    {{--<div class="table-margin" style="height: 500px">--}}
                        {{--<iframe name="Center" src="{{url('')}}" style="border: 0;overflow-y: hidden" width="100%" height="600px">--}}
                        {{--</iframe>--}}
                    {{--</div>--}}
                    <div class="panel panel-default" style="">
                        <div class="panel-heading">奖励佣金导入表单</div>
                        <div class="panel-body" style="font-size:110%">
                            <table class="table table-striped table-responsive table-hover">
                                ...
                                <tr>
                                    <td>时间</td>
                                    <td><input type="month" name="date1"></td>
                                </tr>
                                <tr>
                                    <td>文件选择</td>
