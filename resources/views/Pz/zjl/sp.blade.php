...
<nav class="nav navbar-default navbar-mystyle navbar-fixed-top">
    <div class="navbar-header">
        ...
        <a href="{{url('zjlmain')}}"><div class="navbar-brand mystyle-brand"><span class="glyphicon glyphicon-home"></span></div></a></div>
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            <li class="li-border"><a class="mystyle-color" href="{{url('zjlsp')}}">流程审批</a></li>
            ...
            <div class="sBox">
                ...
                <ul class="navContent" style="display:block">
                    <li>
                        ...
                        <a href="{{url('zjlsearchx')}}" target="Center"><span class="sublist-icon glyphicon glyphicon-credit-card"></span><span class="sub-title">批增未审批</span></a> </li>
                    <li>
                        <div class="showtitle" style="width:100px;"><img src="img/leftimg.png" />批增已审批</div>
                        <a href="{{url('zjlsearchy')}}" target="Center"><span class="sublist-icon glyphicon glyphicon-credit-card"></span><span class="sub-title">批增已审批</span></a> </li>
                    <li>
                </ul>
            </div>
        </div>
