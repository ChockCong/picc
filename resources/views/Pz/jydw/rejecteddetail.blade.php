    ...
    <div class="panel-body" style="font-size:110%">
        <form method="post" action="{{ url('alterject') }}" role="form" enctype="multipart/form-data">
            ...
            <table id="tab" class="table table-striped table-responsive table-hover" border="1" style="text-align:center">
                ...
                <tr>
                    <td>工单编号</td>
                    <td colspan=""><input name="Order1"  readonly value="{{$row->Order1}}"></td>
                    <td>工单标题（必填）</td>
                    <td colspan=""><input name="Title"   value="{{$row->Title}}"></td>
                </tr>
                <tr>
                    <td>公司名称名称</td>
                ...
                <tr>
                    ...
                    <td>申报审批金额(必填)</td>
                    <td><input type="float" name="Num" value="{{$row->Num}}" onkeyup="clearNoNum(this)"></td>
                </tr>
                </tbody>
                <tbody id="tabfile">
                <tr>
                ...
                <tr><td colspan="4"><textarea style="resize: none"  rows="6%" cols="100%" name="Content">{{$row->Content}}</textarea></td></tr>
