...
<div class="panel panel-default" style="">
    ...
    <div class="panel-body" style="font-size:110%">
        <form method="post" action="{{url('fgfzjlpass')}}" role="form" enctype="multipart/form-data">
            ...
            <table id="tab" class="table table-striped table-responsive table-hover" border="1" style="text-align:center">
                ...
                <tr>
                    <td>工单编号</td>
                    <td><input name="Order1"  readonly value="{{$row->Order1}}"></td>

                    <td>工单标题</td>
                    <td ><input name=""  readonly value="{{$row->Title}}"></td>
                <tr>
                    <td>公司名称</td>
