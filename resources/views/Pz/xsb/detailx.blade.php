...
<div class="panel panel-default" style="">
    <div class="panel-heading">未审申报表单</div>
    <div class="panel-body" style="font-size:110%">
        <form method="post" action="{{url('xsbpass')}}" role="form" enctype="multipart/form-data">
            ...
            <table id="tab" class="table table-striped table-responsive table-hover" border="1" style="text-align:center">
                ...
                <tr>
                    <td>公司名称</td>
                    <td><input  readonly value="{{$row->Com}}"></td>
                    <td>申请人</td>
            ...
            <input type="submit" name="pass" value="通过到销售部经理" />&nbsp;<input type="submit" name="pass" value="通过到车险部经理" />
